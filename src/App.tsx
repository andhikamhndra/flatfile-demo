...
export default function App(): any {
  ...
  const [embedId, setEmbedId] = useState(
    "6ff727f7-d878-4092-98cc-bc000d0412e54999431da88c" // eddb35cc-0a1e-4aba-b947-471030e32c60
  );
  const [endUserEmail, setEndUserEmail] = useState(
    localStorage.getItem("end_user_email") || "max-test@flatfile.com"
  );
  const [privateKey, setPrivateKey] = useState(
    "rmV63aZP48ATtOANjCQMX0cJMMB1ZUN4PCsP76JMZqEhNaTkI0lYoHLVUauqcqaC" // 4DX4SRejs2CZDMdz33H4Nk8b9iuHIte3ieoqIJQDMMsStDHNRgsoxOQblJPs0BxB
  );
